...
const game = {
    ...
    render() {
        this.map.render(this.snake.body, this.food.getCoordinates(), this.barrier.getCoordinatesBarrier());
    },
    ...
    tickHandler() {
        ...
        if (this.barrier.isOnPointBarrier(this.snake.getNextHeadPoint())) return this.finish();
